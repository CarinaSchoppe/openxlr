...
public sealed class PipeWireAdapter
{
        ...
        bool exposeHardwareMonitorOutputs = false, string? hardwareSinkHint = null)
    {
        ...
        foreach (JsonElement o in GraphObjects())
        {
            ...
            if (name.StartsWith("OpenXLR_route_", StringComparison.Ordinal) || name.StartsWith("OpenXLR_delay_", StringComparison.Ordinal) || name.StartsWith("OpenXLR_soundcheck_", StringComparison.Ordinal)) continue;
